...
- [ ] побудова демо прототипу:
  ...
  - [ ] формування запиту до Твіттера, враховуємо, що запит не підтримує *regexp*, основний аналіз відбуватиметься на стороні розробника (офлайн), але потрібно відсіяти якамога більше непотребу;
