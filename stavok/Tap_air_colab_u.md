...
Повний одиночний цикл дослідження данних у дуже загальному вигляді можна включає, зокрема, онлайн імпорт даних з довільних джерел, обробку даних (це може бути ваша модель, нейромережа, перетворювач, інше) і візуальне представлення даних. Звичайно ми хочемо зручного управління процесами застосунку і параметрами відображення результатів. Окрім збережених зображень для підготовки статей, презентацій та звітних матеріалів у нас є потреба виставити наші результати у вигляді інтерактивного застосунку не лише на власному комп'ютері, але і на зовні у відкритому веб-доступі.

```mermaid
graph TD
    Dat[(Вхідні дані)]
    Proc[[Обробка даних]]
    Viz[[Інтерактивна візуалізація даних]]
    Par(Параметри обробки і візуалізації)
    Sp(CLI / IDE)
    JN(Jupyter Notebook)
    H(HTML)
    Serv(Сервер)
...
![](D:\boa_uniteam\DOCSIFY\airscape\stavok\tap_air_local.png)
...
|       | time              | sensor_id | val       | factor | …    | yearweek | month | year |
| ----- | ----------------- | --------- | --------- | ------ | ---- | -------- | ----- | ---- |
| 0     | 13.01.2020 0:00   | 10001     | 28.571256 | PM10   | …    | 3        | 1     | 2020 |
| 1     | 13.01.2020  0:00  | 10001     | 26.898551 | PM25   | …    | 3        | 1     | 2020 |
| 2     | 13.01.2020  0:00  | 10049     | 26.591787 | PM10   | …    | 3        | 1     | 2020 |
| 3     | 13.01.2020  0:00  | 10049     | 24.600241 | PM25   | …    | 3        | 1     | 2020 |
| 4     | 13.01.2020  0:00  | 10050     | 29.519324 | PM10   | …    | 3        | 1     | 2020 |
| ...   | ...               | ...       | ...       | ...    | ...  | ...      | ...   | ...  |
| 38011 | 20.04.2020  23:30 | 10049     | 39.765702 | PM25   | …    | 17       | 4     | 2020 |
| 38012 | 20.04.2020  23:30 | 10050     | 24.992754 | PM10   | …    | 17       | 4     | 2020 |
| 38013 | 20.04.2020  23:30 | 10050     | 22.90942  | PM25   | …    | 17       | 4     | 2020 |
| 38014 | 20.04.2020  23:30 | 9969      | NaN       | PM10   | …    | 17       | 4     | 2020 |
| 38015 | 20.04.2020  23:30 | 9969      | NaN       | PM25   | …    | 17       | 4     | 2020 |
...
5. Блокнот Jupyter із цим кодом https://github.com/protw/airscape/blob/master/stavok/Tap_air_colab.ipynb
